...
func (m *MockImageServer) PullImage(ctx context.Context, imageName storage.RegistryImageReference, options *storage.ImageCopyOptions) (storage.PullImageResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PullImage", ctx, imageName, options)
	ret0, _ := ret[0].(storage.PullImageResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
