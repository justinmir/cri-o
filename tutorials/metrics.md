...
| `crio_image_pulls_success_by_registry_total`     | `registry`                                                                                                                                                      | Counter   | Successful image pulls by resolved registry endpoint (the actual registry contacted, which may differ from the image reference when mirrors are configured).                                                                                                                                                                                        |
| `crio_image_pulls_failure_total`                 | `error`                                                                                                                                                         | Counter   | Failed image pulls by their error category.                                                                                                                                                                                                                                                                                                         |
| `crio_image_pulls_failure_by_registry_total`     | `registry`, `error`                                                                                                                                             | Counter   | Failed image pulls by resolved registry endpoint and error category.                                                                                                                                                                                                                                                                                |
